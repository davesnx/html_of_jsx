...
let string_opt_attribute_none =
  test("string_opt_attribute_none", () => {
    let class_ = None;
    let div = <div ?class_ />;
    assert_string(JSX.render(div), {|<div></div>|});
  });
