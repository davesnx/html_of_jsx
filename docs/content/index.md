...
(* <a href="https://x.com/davesnx"><span>Click me!</span></a> *)
```
See [`core`](./core.md) for elements, children, components, and rendering.
...
- [`core`](./core.md) — elements, children, and composition
- [`ppx`](./ppx.md) — PPX flags and settings
- [`how-ppx-works`](./how-ppx-works.md) — JSX transformation, static analysis, and performance
- [`dream`](./dream.md) — integrate with Dream
